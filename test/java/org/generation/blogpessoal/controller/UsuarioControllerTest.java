...
public class UsuarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate; //somente no teste de controller, pois usamos o padrão rest que utiliza dos verbos e métodos HTTP
	
	@Test
	@Order(1)
	@DisplayName("Cadstrar apenas um usuário")
	public void deveCadstrarUmUsuario () {
